...
public class Main {
    public static void main(String[] args) {
        ...
        Map<String,Long> map= students.stream().collect(Collectors.groupingBy(Student::getMajor,Collectors.counting()));
        map.forEach((s,count)->{
            System.out.println("Chuyên ngành: "+s +" |Số lượng: "+ count);
        });
    }
}
